      ...
      <div class="loginbox">
        <div class="loginbox_content">
          ...
          <div class="facedata-label-input">
            ...
            <img v-if="username!=''" class="closeicon" src="../../assets/images/delete@2x.png" @click="clearusername">
          </div>    
          <div class="facedata-label-input">
            <input ref="input" class="facedata-input" type="password" v-model="password" placeholder="请输入密码" >
