  ...
  <div id="Datatreating">
    ...
    >
      ...
      >
        <div
          v-if="item.name=='1'"
          class="datatreating_firstitem"
        >
          <Row>
            <Col span="6">
            <div class="datatreating_firstitem_left">
              <div
                v-for="(tagtree,index) in leftTreeList"
                :key="index"
              >
                <div class="left_name">{{tagtree.name}}</div>
                <div class="left_tree">
                  <linetree
                    :pd="tagtree.linetreelist"
                    @itemClick="itemClick"
                  ></linetree>
                </div>
              </div>
            ...
            <div class="datatreating_firstitem_right">
              <div class="datatreating_fr_content">
                <div class="lf">
                  <div
                    class="header_iconconent cursorpointer"
                    @click="choseleadingin"
                  >
                    <img
                      class="icon"
                      src="../../assets/images/leadingin.png"
                    />
                  ...
                  >
                    <img
                      class="icon"
                      src="../../assets/images/createdata.png"
                    />
        ...
        >
          <iframe
            id="bdIframe"
            ref="ref_iframe"
            src="http://192.168.1.236:8081/miner/v3/dap/store/index.html"
            class='bdIframe'
            frameborder="0"
          ></iframe>
        </div>
        ...
        <div class="datamodal_item">
          ...
          <div class="datamodal_item_flex">
            <Select
              v-model="model8"
              clearable
              class="downloadtemplate_content"
            >
              <Option
